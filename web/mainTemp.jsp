...
<div class="navbar navbar-inverse navbar-fixed-top">
    <div class="navbar-inner">
        <div class="container">
            <a class="brand" href="#">Hss's Diary</a>
            <div class="nav-collapse collapse">
                <ul class="nav">
                    ...
                    <li class="active"><a href="diaryType?action=list"><i class="icon-book"></i>&nbsp;Diary Manage</a></li>
            ...
            <form name="myForm" class="navbar-form pull-right" method="post" action="main?all=true">
                <input class="span2" id="s_title" name="s_title"  type="text" style="margin-top:5px;height:30px;" placeholder="ahhhh...">
